    ...
    <div className="w-full ">
      ...
      >
        <div className="w-[70%] lg:w-[50%] aspect-square flex justify-center items-center bg-transparent relative rounded-sm xl:rounded-md cursor-pointer transition-all group">
          ...
          <span
            data-aos="fade-down"
            className="relative flex justify-center items-center w-full h-full group-hover:border-2 duration-300 group-hover:border-[#9c9c9c77] group-hover:bg-[#9c9c9c77] group-hover:backdrop-blur-sm rounded-xl"
          >
            {img}
          </span>
        </div>
