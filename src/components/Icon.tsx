...
export default function Icon({ img, className }: Props) {
    return (
     <div className="w-[80%] rounded-2xl shadow-md md:bg-transparent md:shadow-none bg-blue-200 flex justify-center aspect-square items-center ">
       <div className="w-[100px] md:w-[125px] aspect-square flex justify-center items-center bg-transparent relative rounded-md cursor-pointer transition-all group">
        ...
        <span className={`absolute inset-0 ${className} rounded-xl transition-transform duration-300 ease-in-out transform origin-bottom group-hover:rotate-[35deg]`}></span>
